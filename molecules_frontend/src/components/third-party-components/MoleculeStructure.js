/**
 * This is a react component taken from 
 * https://github.com/MichelML/rdkit-js/edit/docs/add-original-demo-example/examples/react-example/src/components/MoleculeStructure/MoleculeStructure.js
 * The documentation and examples about how to use this component is available here: 
 * https://michelml.github.io/rdkit-js/examples/react-example/build/#component-example-moleculestructure
 */
